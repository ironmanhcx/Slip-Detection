function [TestY, TestingAccuracy, TestingTime] = elm_kernel_test(TrainedMdl, TestingData_File)
...
OutputWeight = TrainedMdl.OutputWeight;
...
if Elm_Type~=REGRESSION
    ...
    sorted_target=sort(cat(2, TV.T),2);
