function [TrainingY, TrainingAccuracy, TrainingTime, TrainedMdl] = elm_kernel_train(TrainingData_File, Elm_Type, Regularization_coefficient, Kernel_type, Kernel_para)
...
TrainedMdl.P = P;
TrainedMdl.Kernel_type = Kernel_type;
TrainedMdl.Kernel_para = Kernel_para;
TrainedMdl.OutputWeight = OutputWeight;
TrainedMdl.Elm_Type = Elm_Type;
